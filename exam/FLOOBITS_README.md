Error: Command failed: GIT_SSH=/mnt/floobits/id_rsa_floobot.sh git clone --depth 1 --recursive 'https://github.com/Parker876/exam.git' --branch 'master' /mnt/floobits/repos/room_201215
